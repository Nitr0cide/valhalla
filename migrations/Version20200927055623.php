 ...
 */
final class Version20200927055623 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE companies ADD CONSTRAINT FK_8244AA3AC54C8C93 FOREIGN KEY (type_id) REFERENCES companies_type (id)');
